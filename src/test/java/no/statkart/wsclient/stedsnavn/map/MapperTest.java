...
import no.statkart.stedsnavn.ssr.wsapi.v1.domain.StringList;
import no.statkart.stedsnavn.ssr.wsapi.v1.domain.Timestamp;
import no.statkart.stedsnavn.ssr.wsapi.v1.domain.UrlList;
...
public class MapperTest {
    ...
    private <T extends Kode> void assertKodeType(StedsnavnBoble domeneKode, Class<T> kodeClazz) {
        ...
        assertThat(kode.getNavn().getKeyAndValues()).containsExactly(Map.entry("key", "value"));
    }
