...
import no.statkart.wsclient.stedsnavn.endringslogg.Matrikkelreferanse;
import no.statkart.wsclient.stedsnavn.endringslogg.NavneobjekttypeHistorikk;
import no.statkart.wsclient.stedsnavn.endringslogg.Sortering;
import no.statkart.wsclient.stedsnavn.endringslogg.Sted;
import no.statkart.wsclient.stedsnavn.endringslogg.StedTilleggsopplysning;
import no.statkart.wsclient.stedsnavn.endringslogg.Stedsnavn;
import no.statkart.wsclient.stedsnavn.endringslogg.StedsnavnEntityComponentWithHistory;
import no.statkart.wsclient.stedsnavn.endringslogg.StedsnavnInternMerknad;
import no.statkart.wsclient.stedsnavn.endringslogg.StedsnavnTilleggsopplysning;
import no.statkart.wsclient.stedsnavn.endringslogg.StedstatusHistorikk;
import no.statkart.wsclient.stedsnavn.endringslogg.VedtaksmyndighetHistorikk;
import no.statkart.wsclient.stedsnavn.endringslogg.Vegreferanse;
...
public class MapperTest {
   ...
   public void toWsCtx() {
      ...
      no.statkart.wsclient.stedsnavn.endringslogg.StedsnavnContext stedsnavnContext = new no.statkart.wsclient.stedsnavn.endringslogg.StedsnavnContext("3.14", "Identif", "no", snapshotVersion);
   ...
   private void assertStedsnavn(Stedsnavn stedsnavn) {
      ...
      no.statkart.wsclient.stedsnavn.endringslogg.NavnestatusHistorikk historikk = stedsnavn.getNavnestatusHistorikker().get(0);
      ...
      no.statkart.wsclient.stedsnavn.endringslogg.NavnesakstatusHistorikk historikk2 = stedsnavn.getNavnesakstatusHistorikker().get(0);
   ...
   private void assertSted(Sted sted) {
      ...
      List<no.statkart.wsclient.stedsnavn.endringslogg.StedInternMerknad> interneMerknader = sted.getInterneMerknader();
      assertThat(interneMerknader.size()).isEqualTo(1);
      no.statkart.wsclient.stedsnavn.endringslogg.StedInternMerknad stedInternMerknad = interneMerknader.get(0);
      assertFellesFelterForHistoriskKomponent(stedInternMerknad);
      assertThat(stedInternMerknad.getTekst()).isEqualTo("noe tekst");
      assertThat(stedInternMerknad.getFellesarkiv().size()).isEqualTo(1);
      assertThat(stedInternMerknad.getFellesarkiv().iterator().next()).isEqualTo("Fellesarkiv1");
