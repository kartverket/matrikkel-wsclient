...
public class ForsendelseBuilder {
   ...
   public static final int DEFAULT_BELOEPSVERDI = 100;
   ...
   public static final int RETTSSTIFTELSE_DOKUMENTNUMMER = 2356;
   public static final int RETTSSTIFTELSE_DOKUMENTAAR = 2015;
   public static final String RETTSSTIFTELSE_EMBETENUMMER = "44";

   public static final String INNSENDING_ID = "12";
   public static final String INNSENDERS_REFERANSE = "12AZd";
   ...
   public static final int VEDERLAG_BELOEPSVERDI = 560000;
   ...
   public static final int DOKUMENT_AVGIFTSGRUNNLAG_BELOEPSVERDI = 200;
   ...
   public static final int KJOPT_ANDEL_TELLER = 1;
   public static final int KJOPT_ANDEL_NEVNER = 7;
   ...
   public static final int SOLGT_ANDEL_TELLER = 2;
   public static final int SOLGT_ANDEL_NEVNER = 5;
   ...
   public ForsendelseBuilder withInnsendingId(String innsendingId) {
      this.innsendingId = innsendingId;
      return this;
   }

   public ForsendelseBuilder withInnsendersReferanse(String innsendersReferanse) {
   ...
   public ForsendelseBuilder but() {
      return aForsendelse().withIkkeDigitaleSignaturer(ikkeDigitaleSignaturer).withInnsendingId(innsendingId).withInnsendersReferanse(innsendersReferanse).withSignertMelding(signertMelding).withUsignertMelding(usignertMelding);
   }
   ...
   public Forsendelse build() {
      ...
      forsendelse.setInnsendingId(innsendingId);
      forsendelse.setInnsendersReferanse(innsendersReferanse);
   ...
   public static ForsendelseBuilder defaultForsendelse() {
      ...
      no.statkart.wsclient.grunnbok.innsending.domene.Tekst defaultTekst = TekstBuilder.aTekst()
      ...
      return ForsendelseBuilder.aForsendelse()
            .withInnsendingId(INNSENDING_ID)
            .withInnsendersReferanse(INNSENDERS_REFERANSE)
