...
public class LandmalerregisterUtil {
     ...
     */
    public static String validateAndBuildUrlParameters(String landmalernr, String fornavn, String etternavn) {
        // hvis alt er blankt
        if (Stream.of(landmalernr, fornavn, etternavn).allMatch(s -> s == null || s.isBlank())) {
    ...
    private static String buildUrlParameters(String landmalernr, String fornavn, String etternavn) {

        // sjekk hva som er fylt ut
        boolean landmalerUtfylt = landmalernr != null && !landmalernr.isBlank();
        boolean fornavnUtfylt = fornavn != null && !fornavn.isBlank();
        boolean etternavnUtfylt = etternavn != null && !etternavn.isBlank();
