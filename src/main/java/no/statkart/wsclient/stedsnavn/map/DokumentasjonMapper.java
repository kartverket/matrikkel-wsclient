...
import no.statkart.stedsnavn.ssr.wsapi.v1.domain.dokumentasjon.kilde.AnnenKartforekomst;
import no.statkart.stedsnavn.ssr.wsapi.v1.domain.dokumentasjon.kilde.KildeBokreferanse;
import no.statkart.stedsnavn.ssr.wsapi.v1.domain.dokumentasjon.kilde.Kildedokument;
import no.statkart.stedsnavn.ssr.wsapi.v1.domain.dokumentasjon.kilde.LokaleInnsamlinger;
import no.statkart.stedsnavn.ssr.wsapi.v1.domain.dokumentasjon.kilde.Opplysning;
import no.statkart.stedsnavn.ssr.wsapi.v1.domain.dokumentasjon.offentligbruk.DokumentertKlage;
import no.statkart.stedsnavn.ssr.wsapi.v1.domain.dokumentasjon.offentligbruk.DokumentertSamlevedtak;
import no.statkart.stedsnavn.ssr.wsapi.v1.domain.dokumentasjon.offentligbruk.DokumentertVedtak;
import no.statkart.stedsnavn.ssr.wsapi.v1.domain.dokumentasjon.offentligbruk.Kartforekomst;
import no.statkart.stedsnavn.ssr.wsapi.v1.domain.dokumentasjon.offentligbruk.OffentligBokreferanse;
import no.statkart.stedsnavn.ssr.wsapi.v1.domain.dokumentasjon.offentligbruk.OffentligDokument;
